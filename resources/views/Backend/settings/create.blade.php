...
<div class="bg-form">
    ...
    <form class="form-horizontal" method="post">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <select name="s_key" class="form-control">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <input name="s_value" type="text" class="form-control" value="{{ old('s_value') }}">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <input name="s_name" type="text" class="form-control" value="{{ old('s_name') }}">
