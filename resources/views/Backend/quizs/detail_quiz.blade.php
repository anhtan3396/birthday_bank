  ...
  <form class="form-horizontal">
    ...
    <fieldset>
      ...
      <div class="form-group">
        ...
        <label class="col-md-4 control-view" for="comparison">{{ $settingRepository->getName($quiz->level_id,'LEVEL')
          }}</label>
      </div>
      ...
      <div class="form-group">
        ...
        <label class="col-md-4 control-view " for="comparison">{{
          $settingRepository->getName($quiz->quiz_type,'QUIZ_TYPE') }}</label>
      </div>
      <hr>
      <!-- /End Loại -->
      <!-- Nhóm -->
      <div class="form-group">
        ...
        <label class="col-md-4 control-view" for="comparison">{{ $settingRepository->getName($quiz->quiz_kbn,'QUIZ_KBN')
          }}</label>
      </div>
      <hr>
      <!-- /End Nhóm -->
    ...
    <div class="sidebar-footer hidden-small">
      <div class="form-group">
        ...
        <div class="control-button">
          ...
          <a href="{{ asset ('admin/quizs/edit/'. $quiz->id) }}" class="btn btn-success">
