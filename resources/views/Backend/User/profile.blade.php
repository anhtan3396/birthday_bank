  ...
  <form class="form-horizontal" enctype="multipart/form-data" method="post">
    ...
    <fieldset>
      <div class="box-body box-profile">
        ...
        @else
        <img src="{{ URL::asset('upload/image/avatar/'.$user->avatar) }}" alt="..."
          class="profile-user-img img-responsive img-circle">
        @endif
        ...
        <ul class="list-group list-group-unbordered">
          ...
          <li class="list-group-item">
            <b>Số điện thoại</b>
            <p class="pull-right">{{$user->phone_num}}</p>
          </li>
          <li class="list-group-item">
            @if($created_user == null)
            <b>Người Tạo</b>
            <p class="pull-right">{{ MUser::find(1)->nick_name }}</p>
            @else
            <b>Người Tạo</b>
            <p class="pull-right">{{ $created_user->nick_name }}</p>
            @endif

          </li>
          <li class="list-group-item">
            <b>Ngày tạo</b>
            <p class="pull-right">{{$user->created_time}}</p>
          </li>
          <li class="list-group-item">
            <b>Số xu hiện có</b>
            <p class="pull-right">{{$user->remain_coin}}</p>
          </li>
          <li class="list-group-item">
            <b>Chức vụ</b>
            <p class="pull-right">{{ $settingRepository->getName($user->user_role,"USER_ROLE") }}</p>
          </li>
        </ul>
      </div>
